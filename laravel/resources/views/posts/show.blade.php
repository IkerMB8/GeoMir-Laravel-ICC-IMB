    ...
    <div class="posts">
            <div class="post">
                                    ...
                                    <div style="height: 620px; display: flex; flex-direction: column; justify-content: space-between;">
                                        <div style="height:300px"></div>
                                            <div class="modal-footer" style="margin-left:10px; border: 2px solid black;background-color: white;border-radius: 25px; display:flex; justify-content: space-between; ">
                                                <div style="float:left;">
                                                    <form>
                                                        <input style="border:0; float:left;" type="textarea" maxlength="140" postholder="Escriba aquí su comentario"/>
                                                    </form>
                                                </div>
                ...
                <div>
                    ...
                    <form style="display:flex;justify-content:center;" method="post" action="{{ route('posts.destroy',$post) }}" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-primary">{{ __('fields.delete') }}</button>
                        <a style="margin-left:10px;margin-right:10px;" href="{{ route('posts.edit',$post) }}" class="btn btn-secondary">Edit</a>
